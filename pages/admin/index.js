...
export default function Admin() {
  ...
  const [tabActiva, setTabActiva] = useState("nuevo"); // 'nuevo' | 'lista' | 'precios'
  ...
  return (
    ...
    >
      ...
      {/* BARRA DE PESTAÑAS PRINCIPALES PARA CELULAR */}
      <div
        style={{
          background: "#fff",
      ...
      <div className="container" style={{ marginTop: 16 }}>
        {/* PESTAÑA 1: FORMULARIO DE CARGA RÁPIDA */}
        {tabActiva === "nuevo" && (
          <form onSubmit={handleSubmit}>
            ...
            {/* BOTÓN PARA ABRIR/CERRAR DATOS SECUNDARIOS */}
            ...
            {/* BARRA FIJA DE GUARDAR ABAJO (CÓMODA EN CELULAR) */}
            <div
              style={{
                position: "fixed",
                bottom: 0,
        ...
        {/* PESTAÑA 2: LISTA DE PRODUCTOS OPTIMIZADA PARA CELULAR */}
        {tabActiva === "lista" && (
          <div>
            <input
              type="text"
        ...
        {/* PESTAÑA 3: CONFIGURAR PRECIOS OCULTOS */}
        {tabActiva === "precios" && (
          <div
            style={{
              background: "#fff",
